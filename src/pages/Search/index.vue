        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li class="active">
                  <a :class="{ active: isOne }" @click="changeOrder('1')">综合<span v-show="isOne" class="iconfont"
                      :class="{ 'icon-upload': isAsc, 'icon-download': isDesc }"></span></a>
                </li>
                <li>
                  <a :class="{ active: isTwo }" @click="changeOrder('2')">价格<span v-show="isTwo" class="iconfont"
                      :class="{ 'icon-upload': isAsc, 'icon-download': isDesc }"></span></a>
                </li>
              </ul>
            </div>
...
export default {
  ...
  // 在挂载之前，我们需要修改searchParams
  beforeMount() {
    // 使用Object.assign合并对象中的属性
